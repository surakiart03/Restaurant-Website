...
class Food_Restro_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'food_restro';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'food-restro' ), $i ),
...
// Initialize.
$food_restro_footer_widgets = new Food_Restro_Footer_Widgets();
